...
const stages = [
  {
    ...
    copy: "Your dispatchers should not spend the morning checking 75 loads to discover that six have problems. The system of record can hold the data while the operation still loses time finding the work.",
